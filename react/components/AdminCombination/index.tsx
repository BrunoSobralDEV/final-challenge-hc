...
const COMBINATION_LENGTH = 100;
const MOCKED_DATA = [...Array(COMBINATION_LENGTH)].map(() => ({
  name: getProduct.name.findName(),
  streetAddress: getSuggestions.address.streetAddress(),
  cityStateZipAddress: `${getSuggestions.address.city()}, ${getSuggestions.address.stateAbbr()} ${getSuggestions.address.zipCode()}`,
  email: getSuggestions.internet.email().toLowerCase(),
}));
